      ...
      <div className="relative w-full h-80 rounded-2xl overflow-hidden shadow-xl group">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-12">
           <div className="max-w-2xl animate-in slide-in-from-bottom duration-700">
             ...
             <p className="text-lg text-brand-beige/90 mb-6 max-w-lg leading-relaxed">
               {t('heroSubtitle')}
             </p>
             <button className="bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-md px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 w-fit">
               {t('exploreVision')}
